...
namespace PizzaKulesiCodeFirst
{
    public partial class DuzenleForm : Form
    {
        ...
        private void btnDuzenle_Click(object sender, EventArgs e)
        {
            ...
            btnEkstraMalzemeEkle.Enabled = btnPizzaEkle.Enabled = btnEkstraMalzemeSil.Enabled = btnPizzaSil.Enabled = false;
        ...
        private void FormuResetle()
        {
            ...
            btnEkstraMalzemeEkle.Enabled = btnPizzaEkle.Enabled = btnEkstraMalzemeSil.Enabled = btnPizzaSil.Enabled = true;
        }
