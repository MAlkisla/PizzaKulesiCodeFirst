    ...
    public partial class Form1 : Form
    {
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            if (btnEkle.Text == "Kaydet")
            {
                ...
                seciliSiparis.TeslimDurumu = chkTeslimDurumu.Checked;
                db.SaveChanges();
                SiparisleriListele();
                FormuResetle();
                return;
            ...
            Siparis siparis = new Siparis()
            {
                ...
                TeslimDurumu = chkTeslimDurumu.Checked == true ? true : false
            };
        ...
        private void btnDuzenle_Click(object sender, EventArgs e)
        {
            ...
            chkTeslimDurumu.Checked = seciliSiparis.TeslimDurumu;
